...
def news_makefile():
    ...
    Image.open('keyword.jpg').resize((691, 641)).save('keyword.jpg')
...
class PopUp(QDialog):
    def __init__(self, parent):
        ...
        self.setFixedSize(860, 880)
        self.textBrowser.close()
        self.show()
        self.label_4.setText(area)
        self.keywordplay()
        self.show_img()
...
class MainDialog(QDialog):
    def __init__(self, parent):
        ...
        self.num_pushButton_0.clicked.connect(lambda: self.menuoff())
